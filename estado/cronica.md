...
## 2026-09-04 05:25 UTC · Día 1, primavera del año 1, 06:30
- 21 habitantes, 0 difuntos en total, 0 obras levantadas, tesoro de 0 monedas. Grano 80, madera 60, piedra 35.
- Gobierna Irene, popularidad 60 %.
- Nace el pueblo.
- Irene gobierna Valdecerro desde el castillo

## 2026-09-04 05:40 UTC · Día 4, primavera del año 1, 20:45
- 24 habitantes, 0 difuntos en total, 6 obras levantadas, tesoro de 18 monedas. Grano 61, madera 11, piedra 26.
- Gobierna Irene (decreto: austeridad), popularidad 69 %.
- Desde el último latido pasaron 3 días: la población pasó de 21 a 24, se levantaron 6 obras.
- 22 sucesos notables; los últimos:
- Llega Clara por el camino del este y se instala como agricultora
- Termina un campo de cultivo: el pueblo crece
- Empieza la obra de un campo de cultivo
- Llega Unai 29 por el camino del este y se instala como minero
- La caravana vende 10 de madera; el pueblo gasta 19 monedas
- Elena y Gonzalo forman una familia
- Termina un campo de cultivo: el pueblo crece
- Empieza la obra de un campo de cultivo
- Termina un campo de cultivo: el pueblo crece
- Empieza la obra de un campo de cultivo
- Jorge y Ramiro forman una familia
- Félix y Beatriz forman una familia
- Termina un campo de cultivo: el pueblo crece
- Empieza la obra de un campo de cultivo
- La caravana vende 10 de madera; el pueblo gasta 19 monedas
- Termina un campo de cultivo: el pueblo crece

## 2026-09-04 10:35 UTC · Día 78, invierno del año 5, 17:41
- 40 habitantes, 40 difuntos en total, 17 obras levantadas, tesoro de 405 monedas. Grano 353, madera 162, piedra 72.
- Gobierna Rocío 42 (decreto: saber), popularidad 96 %.
- Saberes: arado, cartografia, alumbrado, medicina.
- Desde el último latido pasaron 74 días: la población pasó de 24 a 40, hubo 40 difuntos, se levantaron 11 obras.
- 258 sucesos notables; los últimos:
- Carmen 97 y Rocío 203 forman una familia
- Llega Bruno 221 por el camino del sur y se instala como agricultor
- Rocío 42 proclama: decreto de cosecha: todos al campo
- Parte una expedición a explorar al este del valle
- La expedición descubre un yacimiento de hierro al este; los mineros ya tienen camino
- La caravana compra 40 de grano, 40 de madera, 20 de mineral, 10 de oro; el pueblo gana 320 monedas
- Se instalan 1 farol más por los caminos
- Hugo 105 el leñador muere de viejo
- Ximena 120 la agricultora muere de vieja
- Hugo 80 y Damián 103 forman una familia
- Llega Hugo 228 por el camino del sur y se instala como agricultor
- Llega Gema 229 por el camino del este y se instala como agricultora
- Rocío 42 proclama: decreto de saber: se protege a los estudiosos
